...
**Thread safety:** The solution should be ready to handle concurrent requests for a single cart - i.e. parallel calls for cart modifications should not result in race conditions or inconsistent states.
...
- https://raw.githubusercontent.com/siriusxm/shopping-cart-test-data/main/bread.json
- https://raw.githubusercontent.com/siriusxm/shopping-cart-test-data/main/cheese.json
- https://raw.githubusercontent.com/siriusxm/shopping-cart-test-data/main/eggs.json
- https://raw.githubusercontent.com/siriusxm/shopping-cart-test-data/main/milk.json
- https://raw.githubusercontent.com/siriusxm/shopping-cart-test-data/main/peanut-butter.json

## Sample based on the data
The below is a sample with the correct values you can use to confirm your calculations
```
  Add 2 × bread @ 2.52 each
  Add 1 × peanut butter @ 5.75 each
  Subtotal = 10.79
  Tax = 1.35
  Total = 12.14
```
...
You can either use latest 2.13.x or 3.x. By default this repository uses 2.13, but feel free to change it. 
